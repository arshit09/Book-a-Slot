...
pyautogui.click(411, 919, duration = 0.9)
# click on Sign in button
pyautogui.click(448, 985)
# wait to load the page
time.sleep(1.25)
# click on Continue button
pyautogui.click(1461, 317)
# click on "Reschedule Appointment"
pyautogui.click(392, 544, duration = 0.9)
# click on "Reschedule Appointment" button
pyautogui.click(673, 663, duration = 0.5)
# click on center of "Date of Appointment" input box
pyautogui.click(700, 664, duration = 0.5)
...
while (month_color != None) and (month_back_button_count != 6):
    # calendar screenshot resolution
    # 504 751
    #         1000 911
    image = pyautogui.screenshot(region=(504, 751, 496, 160))
    image = cv2.cvtColor(np.array(image), cv2.COLOR_RGB2BGR)
    cv2.imwrite("C://Users//arshit//Desktop//visa script//Images//Appointment.png", image)
    color_thief = ColorThief("C://Users//arshit//Desktop//visa script//Images//Appointment.png")
